...
@bin\H264AVCEncoderLibTestStatic -pf cfg\Foreman.cfg -numl 2                                   -encfgs 0 80.0 tmp\Foreman_FGS0.dat -encfgs 1 256.0 tmp\Foreman_FGS1.dat -bf str\Foreman01

@bin\EncoderBitstreamMergerStatic.exe -numl 2 -ql tmp\Foreman -infile 0 str\Foreman01 -outfile str\Foreman_CIF30-256.264
